...
// Evaluacion → Entregas
Evaluacion.hasMany(Entrega, { foreignKey: 'evaluacion_id', as: 'entregas', onDelete: 'NO ACTION', onUpdate: 'CASCADE' });
Entrega.belongsTo(Evaluacion, { foreignKey: 'evaluacion_id', as: 'evaluacion', onDelete: 'NO ACTION', onUpdate: 'CASCADE' });

// Matricula → Entregas
Matricula.hasMany(Entrega, { foreignKey: 'matricula_id', as: 'entregas', onDelete: 'NO ACTION', onUpdate: 'CASCADE' });
Entrega.belongsTo(Matricula, { foreignKey: 'matricula_id', as: 'matricula', onDelete: 'NO ACTION', onUpdate: 'CASCADE' });
